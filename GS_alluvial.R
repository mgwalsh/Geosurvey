...
alluvial(TZ_geof[,1:3], freq=TZ_geof$Freq, border=NA, col=ifelse(TZ_geof$CP == "Y", "red", "gray"))
alluvial(ET_geof[,1:3], freq=ET_geof$Freq, border=NA, col=ifelse(ET_geof$CP == "Y", "red", "gray"))
alluvial(NG_geof[,1:3], freq=NG_geof$Freq, border=NA, col=ifelse(NG_geof$CP == "Y", "red", "gray"))
alluvial(GH_geof[,1:3], freq=GH_geof$Freq, border=NA, col=ifelse(GH_geof$CP == "Y", "red", "gray"))
dev.off()
