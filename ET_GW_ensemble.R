...
crp.thld <- threshold(crp.eval, 'spec_sens') ## max TPR+TNR threshold for classification
...
hsp.thld <- threshold(hsp.eval, 'spec_sens') ## max TPR+TNR threshold for classification
