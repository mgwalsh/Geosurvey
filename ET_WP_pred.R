# Stacked predictions of Ethiopia woody vegetation cover >60% observations
...
writeRaster(wppreds, filename="./Results/ET_wppreds_2017.tif", datatype="FLT4S", options="INTERLEAVE=BAND", overwrite=T)
