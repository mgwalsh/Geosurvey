...
cp_cal <- gs_cal$CP ## Buildings in Croplands present? (Y/N)
...
r <- matrix(c(0, t[,2], 0, t[,2], 2, 1), ncol=3, byrow = T) ## set threshold value <kappa>
...
# save widget
saveWidget(w, 'NG_CP.html', selfcontained = T)
