# Stacked predictions of Nigeria cropland observations
...
# Data setup --------------------------------------------------------------
# Run this first: https://github.com/mgwalsh/Geosurvey/blob/master/NG_GS_data.R
# or run ...
# SourceURL <- "https://raw.githubusercontent.com/mgwalsh/blob/master/NG_GS_data.R"
...
gf_cal <- gs_cal[,9:37] ## grid covariates
...
writeRaster(cppreds, filename="./Results/NG_cppreds_2017.tif", datatype="FLT4S", options="INTERLEAVE=BAND", overwrite=T)
